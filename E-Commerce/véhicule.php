...
<body>
    ...
    if (isset($_POST['nouvelEtat']) && isset($_POST['id'])) {
        // Échapper les valeurs pour éviter les attaques par injection SQL
        $nouvelEtat = $_POST['nouvelEtat'];
        $id = $_POST['id'];

        // Mettre à jour l'état dans la base de données
        $sql = "UPDATE vehicule SET etat = :nouvelEtat WHERE id = :id";
        $stmt = $pdo->prepare($sql);
        $stmt->bindParam(':nouvelEtat', $nouvelEtat);
    ...
    <div class="container">
                <ul class="responsive-table">
                    <li class="table-header">
                        ...
                        <div class="col">État de véhicule</div>
                    </li>
                    <?php
                    ...
                    <li class="table-row">
                        ...
                        <div class="col" data-label="Matricule"><?php echo $row['matricule'] ?></div>
                        <div class="col" data-label="Nom de véhicule"><?php echo $row['marque'] ?></div>
                        <div class="col" data-label="État de véhicule">
                           <div class="box">
