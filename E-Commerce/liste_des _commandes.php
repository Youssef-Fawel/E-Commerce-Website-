           ...
           <div class="container">
                <ul class="responsive-table">
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ?>
                    <li class="table-row">
                        <div class="col" data-label="Id"><?php echo $row['email'] ?></div>
                        <div class="col" data-label="Matricule"><?php echo $row['nom_produit'] ?></div>
                                   <div class="col" data-label="Nom de véhicule"><?php echo $row['prix'] ?></div>
                        <div class="col" data-label="Nom de véhicule"><?php echo $row['quantite'] ?></div>
              
                        <div class="col" data-label="Nom de véhicule"><?php echo $row['total'] ?></div>
